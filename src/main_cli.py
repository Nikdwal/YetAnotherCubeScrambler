...
def main():
    ...
    scramble_building_group.add_option("-c", "--ocll", dest="ocll", help="The corner orientation case in the last layer. This overrides every other method of orienting corners. Possible options are T, U, L, H, Pi, S, AS. You can list multiple possibilities, delimited by spaces. If this option isn't used, any case could be generated (unless CO is restricted by another option) ")
